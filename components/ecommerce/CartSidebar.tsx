...
import { formatCommercePrice } from "@/lib/commerce/product-normalization";
            ...
            <div className="flex-1 overflow-y-auto p-6 space-y-6">
              {items.length === 0 ? (
                ...
                items.map((item) => {
                  ...
                  const productIdentifier = item.slug || item.productId || item.id || item._id;
                      ...
                      <div className="flex-1 flex flex-col justify-between">
                        <div>
                          ...
                          <div className="flex items-center gap-2 mt-2">
                            <span className="text-red-600 font-bold text-sm">
                              {formatCommercePrice(price, item.currency || "INR")}
                            </span>
                            {comparePrice && (
                        ...
                        <div className="flex items-center justify-between mt-3">
                          ...
                          <div className="flex items-center gap-2 text-muted">
                            <Link href={`/product/${productIdentifier}`} onClick={onClose} className="p-1 hover:text-foreground transition-colors">
                              <Edit2 size={14} />
                            </Link>
                            <button
            ...
            <div className="p-6 bg-muted/5">
              <div className="flex justify-between items-center mb-6">
                ...
                <span className="text-lg font-black text-foreground">
                  {formatCommercePrice(cartTotal, items[0]?.currency || "INR")}
                </span>
              </div>
